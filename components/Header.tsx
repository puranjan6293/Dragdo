    ...
    <header>
      <div className="flex flex-col md:flex-row items-center p-5 bg-gray-500/10 rounded-b-2xl">
        ...
        <div className="flex items-center space-x-5 flex-1 justify-end w-full">
          ...
          <Avatar name="Dragdo" round size="50" color="#0055D1" />
        </div>
      </div>
      <div className="flex items-center justify-center px-5 py-2 md:py-5">
        <p className="flex items-center text-sm font-light pr-5 shadow-xl rounded-xl w-fit bg-white italic max-w-3xl text-[#0055D1]">
          <CheckCircleIcon className="inline-block h-10 w-10 text-[#0055D1] mr-1 " />
          Dragdo summerising your tasks for the day...
        </p>
      </div>
    </header>
  );
